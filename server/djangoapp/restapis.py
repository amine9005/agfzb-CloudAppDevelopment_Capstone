...
def analyze_review_sentiments(dealerreview):
    ...
    try:
        ...
        return json.dumps({"label":"neutral"})
...
def post_request(url, json_payload, **kwargs):
    print("\njson_payload: ",json_payload['review'])

    try:
        print("Here is Here")
        response = requests.post(url, data=json_payload['review'])
        print("Response ",response)
        status_code = response.status_code
        print("Response Text: ",response.text )

        print("POST status {} ".format(status_code))
    except:
        # If any error occurs
        warnings.warn("Network exception occurred")
